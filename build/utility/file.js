...
exports.writeInFile = exports.readFileData = exports.outputFilePath = exports.createOutputFile = void 0;
...
function createOutputFile() {
    var configFilename = outputFilePath();
...
function outputFilePath() {
    return path_1.default.join(__dirname, "../../../", "output.json");
}
...
function readFileData() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fileSystem.readFile(outputFilePath(), { encoding: 'utf-8' })];
                case 1:
                    data = _a.sent();
                    return [2 /*return*/, data ? JSON.parse(data) : Object.create({})];
            }
        });
    });
}
...
function writeInFile(data) {
    fs_1.default.writeFileSync(outputFilePath(), JSON.stringify(data));
}
